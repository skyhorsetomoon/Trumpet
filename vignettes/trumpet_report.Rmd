...
If **OUTPUT\_DIR=NA**, the generated result of asseessment report will be saved in current path. As an exmaple, you can look at the result in *doc* folder of the `Trumpet` R-package.
