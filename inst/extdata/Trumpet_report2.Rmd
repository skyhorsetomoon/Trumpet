...
# 7 Compare IP samples' enrichment signal to knowing data set.

In this part, we will compare the user's IP samples' enrichment signal to the our knowing experiment data set. We use the dot plot to show the distribution of IP samples' signal strength that was depicted by the percentage of enrichment region, the percentage of signal reads count and scale factor. The following plot will show the result.
